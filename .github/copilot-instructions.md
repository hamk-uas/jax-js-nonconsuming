...
| Stencil body synthesis for halo-VJP                         | `transposeJaxpr` converts UDS reads → scatterAdd writes (wrong shape for gather). Gather-based VJP requires synthesizing a new backward body for linear stencils; pad+add fallback for general bodies                                                                                                                          |
