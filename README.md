...
| **`lax.associativeScan`**          | Not implemented                             | Kogge-Stone parallel prefix scan; pytrees, any axis, reverse, autodiff. For GPU-heavy compose bodies, wrap the whole call in `jit(...)` for best acceleration. |
